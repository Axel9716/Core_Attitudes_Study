...
Next, I verify that there are no null values. No variable in this dataset should be null, because they are encoded as negative numbers. I also want to first recode the null values (stored as negatives) into 0's 
...
wvs_data <- wvs_data |> 
 mutate(across(4:126, \(x) ifelse(x < 0, 0, x)))
